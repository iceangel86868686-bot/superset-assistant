import { CombinationFilter, CombinationOperator, ComparisonFilter, ComparisonOperator, FillSymbolizer, Filter, GrayChannel, IconSymbolizer, LineSymbolizer, MarkSymbolizer, NegationFilter, NegationOperator, Operator, PropertyType, RasterSymbolizer, RGBChannel, Rule, ScaleDenominator, TextSymbolizer, Expression, GeoStylerBooleanFunction, GeoStylerNumberFunction, GeoStylerStringFunction, GeoStylerUnknownFunction, GeoStylerFunction, PointSymbolizer, Symbolizer, FunctionCall, Sprite } from './index';
export declare const isExpression: (got: any) => got is Expression<any>;
/**
 * @deprecated use isFunction instead
 */
export declare const isFunctionCall: (got: any) => got is FunctionCall<any>;
export declare const isPropertyType: (got: any) => got is PropertyType;
...
export declare const isNegationOperator: (got: any) => got is NegationOperator;
