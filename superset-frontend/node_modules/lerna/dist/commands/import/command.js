...
var import_dedent5, import_fs_extra8, import_p_map_series, import_path13, childProcess11, ImportCommand;
var init_src3 = __esm({
  "libs/commands/import/src/index.ts"() {
    "use strict";
    init_src2();
    ...
    ImportCommand = class extends Command {
      ...
      initialize() {
        ...
        const externalRepoPath = import_path13.default.resolve(inputPath ?? "");
        const externalRepoBase = import_path13.default.basename(externalRepoPath);
        ...
        const packageJson = import_path13.default.join(externalRepoPath, "package.json");
        ...
        const targetDir = import_path13.default.join(targetBase, externalRepoBase);
        const gitRepoRoot = this.getWorkspaceRoot();
        const lernaRootRelativeToGitRoot = import_path13.default.relative(gitRepoRoot, this.project.rootPath);
        this.targetDirRelativeToGitRoot = import_path13.default.join(lernaRootRelativeToGitRoot, targetDir);
        ...
        if (import_fs_extra8.default.existsSync(import_path13.default.resolve(this.project.rootPath, targetDir))) {
      ...
      getPackageDirectories() {
        return this.project.packageConfigs.filter((p) => p.endsWith("*")).map((p) => import_path13.default.dirname(p));
      }
      getTargetBase() {
