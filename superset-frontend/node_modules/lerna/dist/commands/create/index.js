...
var import_node_events2, import_node_util2, consoleControl, Logger2, log, trackerConstructors, mixinLog, npmlog_default;
...
async function writePackage(filePath, data) {
  const resolvedPath = import_path.default.basename(filePath) === "package.json" ? filePath : import_path.default.join(filePath, "package.json");
...
var import_promises, import_path, dependencyKeys;
...
var import_devkit, import_fs, import_load_json_file, import_npm_package_arg, import_path2, PKG, _location, _resolved, _rootPath, _scripts, _contents, Package;
...
async function tempWrite(fileContent, filePath) {
  ...
  await import_node_fs.default.promises.mkdir(import_path12.default.dirname(tempPath), { recursive: true });
  await write(tempPath, fileContent);
  return tempPath;
}
var import_node_crypto, import_node_fs, import_node_os2, import_path12, tempDir, tempfile, writeStream;
var init_temp_write = __esm({
  "libs/core/src/lib/temp-write.ts"() {
    ...
    tempfile = (filePath) => import_path12.default.join(tempDir, (0, import_node_crypto.randomUUID)(), filePath || "");
    ...
    tempWrite.sync = (fileContent, filePath) => {
      const tempPath = tempfile(filePath);
      import_node_fs.default.mkdirSync(import_path12.default.dirname(tempPath), { recursive: true });
...
var require_builtin_npmrc = __commonJS({
  "libs/commands/create/src/lib/builtin-npmrc.ts"(exports2, module2) {
    ...
    function builtinNpmrc() {
      let resolvedPath = "";
      try {
        resolvedPath = import_path13.default.resolve(
          import_fs_extra8.default.realpathSync(import_path13.default.join(import_path13.default.dirname(process.execPath), "npm")),
          "../../npmrc"
        );
      } catch (err) {
      }
...
var require_cat_file = __commonJS({
  "libs/commands/create/src/lib/cat-file.ts"(exports2, module2) {
    ...
    function catFile(baseDir, fileName, content, opts = "utf8") {
      return import_fs_extra8.default.writeFile(import_path13.default.join(baseDir, fileName), `${content}
`, opts);
    }
  }
});
...
var require_src = __commonJS({
  "libs/commands/create/src/index.ts"(exports2, module2) {
    ...
    var LERNA_MODULE_DATA = require.resolve(import_path13.default.join(__dirname, "./lib/lerna-module-data.js"));
    ...
    var CreateCommand = class extends Command {
      initialize() {
        ...
        this.targetDir = import_path13.default.resolve(this.pkgsDir, this.dirName);
        this.binDir = import_path13.default.join(this.targetDir, "bin");
        this.binFileName = bin === true ? this.dirName : bin;
        this.libDir = import_path13.default.join(this.targetDir, esModule ? "src" : "lib");
        this.libFileName = `${this.dirName}.js`;
        this.testDir = import_path13.default.join(this.targetDir, "__tests__");
      ...
      _getPackagesDir(pkgLocation) {
        ...
        const normalizedPkgLocation = import_path13.default.resolve(this.project.rootPath, import_path13.default.normalize(pkgLocation)).toLowerCase();
      ...
      async execute() {
        await import_fs_extra8.default.mkdirp(this.libDir);
        await import_fs_extra8.default.mkdirp(this.testDir);
        await Promise.all([this.writeReadme(), this.writeLibFile(), this.writeTestFile()]);
        if (this.binFileName) {
          await import_fs_extra8.default.mkdirp(this.binDir);
        ...
        if (this.options.esModule) {
          this.logger.notice(
            ...
            import_dedent5.default`
              Ensure '${import_path13.default.relative(".", this.pkgsDir)}/*/${this.outDir}' has been added to ./.gitignore
        ...
        this.logger.success(
          "create",
          `New package ${data.name} created at ./${import_path13.default.relative(".", this.targetDir)}`
        );
      }
      gitConfig(prop) {
      ...
      resolveRelative(depNode) {
        const relPath = import_path13.default.relative(this.targetDir, depNode.package.location);
        const spec = import_npm_package_arg8.default.resolve(depNode.package.name, relPath, this.targetDir);
      ...
      setHomepage() {
        ...
        const relativeTarget = import_path13.default.relative(this.project.rootPath, this.targetDir);
        if (hurl.hostname.match("github")) {
          hurl.pathname = import_path13.default.posix.join(hurl.pathname, "tree/main", relativeTarget);
          hurl.hash = "readme";
        } else if (!this.options.homepage) {
          hurl.pathname = import_path13.default.posix.join(hurl.pathname, relativeTarget);
        }
...
// packages/lerna/src/commands/create/index.ts
var createIndex = require_src();
