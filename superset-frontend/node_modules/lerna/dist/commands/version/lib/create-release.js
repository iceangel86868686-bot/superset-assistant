...
var import_make_fetch_happen2, import_path10, GitLabClient;
...
Request returned ${status} ${statusText}`);
      ...
      releasesUrl(namespace, project) {
        return new URL(
          `${this.baseUrl}/${import_path10.default.join("projects", encodeURIComponent(`${namespace}/${project}`), "releases")}`
        ).toString();
      }
    };
  }
