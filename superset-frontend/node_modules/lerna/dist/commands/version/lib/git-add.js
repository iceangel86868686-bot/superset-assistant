...
function findPrefix(start) {
  let dir = import_path6.default.resolve(start);
  let walkedUp = false;
  while (import_path6.default.basename(dir) === "node_modules") {
...
function find(name, original) {
  ...
  try {
    ...
    const dirname = import_path6.default.dirname(name);
    if (dirname === name) {
      return original;
    }
...
function parseField(input, key) {
  ...
  const isPath = typeList.indexOf(import_path7.default) !== -1;
  ...
  if (isPath) {
    ...
    if (regex.test(field) && process.env["HOME"]) {
      field = import_path7.default.resolve(process.env["HOME"], field.substr(2));
    }
    field = import_path7.default.resolve(field);
  }
...
var import_assert, import_fs4, import_path8, ConfigChain, Conf;
var init_conf = __esm({
  "libs/core/src/lib/npm-conf/conf.ts"() {
    "use strict";
    ...
    Conf = class extends ConfigChain {
      ...
      loadPrefix() {
        ...
        Object.defineProperty(this, "globalPrefix", {
          ...
          get: () => import_path8.default.resolve(this["get"]("prefix"))
        });
        let p;
        ...
        if (Object.prototype.hasOwnProperty.call(cli, "prefix")) {
          p = import_path8.default.resolve(cli.prefix);
        } else {
          try {
      ...
      loadUser() {
        ...
        const prefix = import_path8.default.resolve(this["get"]("prefix"));
        try {
...
async function tempWrite(fileContent, filePath) {
  ...
  await import_node_fs.default.promises.mkdir(import_path9.default.dirname(tempPath), { recursive: true });
  await write(tempPath, fileContent);
  return tempPath;
}
var import_node_crypto, import_node_fs, import_node_os2, import_path9, tempDir, tempfile, writeStream;
var init_temp_write = __esm({
  "libs/core/src/lib/temp-write.ts"() {
    ...
    tempfile = (filePath) => import_path9.default.join(tempDir, (0, import_node_crypto.randomUUID)(), filePath || "");
    ...
    tempWrite.sync = (fileContent, filePath) => {
      const tempPath = tempfile(filePath);
      import_node_fs.default.mkdirSync(import_path9.default.dirname(tempPath), { recursive: true });
...
function resolvePrettier() {
  if (!resolvedPrettier) {
    try {
      const packageJson = (0, import_devkit5.readJsonFile)(import_path10.default.join(import_devkit5.workspaceRoot, "package.json"));
...
async function maybeFormatFile(filePath) {
  ...
  const ignorePath = import_path10.default.join(import_devkit5.workspaceRoot, ".prettierignore");
  const fullFilePath = import_path10.default.join(import_devkit5.workspaceRoot, filePath);
...
async function gitAdd(changedFiles, gitOpts, execOpts) {
  ...
  for (const file of changedFiles) {
    const filePath = (0, import_slash2.default)(import_path10.default.relative(execOpts.cwd, import_path10.default.resolve(execOpts.cwd, file)));
...
var import_devkit5, import_fs5, import_path10, import_slash2, childProcess11, resolvedPrettier;
