  ...
  "libs/commands/clean/src/index.ts"(exports2, module2) {
    ...
    var CleanCommand = class extends Command {
      ...
      initialize() {
        ...
        this.logger.info(
          "clean",
          this.directoriesToDelete.map((dir) => import_path14.default.relative(this.project.rootPath, dir)).join("\n")
        );
      ...
      execute() {
        ...
        return (0, import_p_map3.default)(this.directoriesToDelete, mapper, { concurrency: this.concurrency }).then(() => {
          tracker.finish();
