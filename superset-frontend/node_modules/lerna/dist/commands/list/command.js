...
function formatColumns(resultList, viewOptions) {
  const formattedResults = resultList.map((project) => {
    ...
    formatted.location = import_chalk3.default.grey(import_path10.default.relative(".", pkg.location));
    return formatted;
  });
...
var import_node_crypto, import_node_fs, import_node_os2, import_path14, tempDir, tempfile, writeStream;
