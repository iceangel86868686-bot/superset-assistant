...
function getCycles(dependencies) {
  ...
  function dfs(next, path12) {
    visited.add(next);
    path12.push(next);
    for (const dep of dependencies[next] || []) {
      if (path12.includes(dep)) {
        const cycle = path12.slice(path12.indexOf(dep));
        cycles.push(cycle);
...
var require_types = __commonJS({
  "libs/core/src/lib/npm-conf/types.ts"(exports2) {
    ...
    exports2.types = {
      ...
      cafile: import_path15.default,
      cache: import_path15.default,
      ...
      global: Boolean,
      globalconfig: import_path15.default,
      ...
      "init-module": import_path15.default,
      ...
      tag: String,
      timing: Boolean,
      tmp: import_path15.default,
      unicode: Boolean,
      "unsafe-perm": Boolean,
      "update-notifier": Boolean,
      usage: Boolean,
      user: [Number, String],
      userconfig: import_path15.default,
      umask: Umask,
      version: Boolean,
...
var require_config_chain = __commonJS({
  "libs/core/src/lib/npm-conf/config-chain/index.ts"(exports2, module2) {
    ...
    var find2 = exports2.find = function() {
      var rel = path12.join.apply(null, [].slice.call(arguments));
      function find3(start, rel2) {
        var file = path12.join(start, rel2);
        try {
          fs12.statSync(file);
          return file;
        } catch (err) {
          if (path12.dirname(start) !== start)
            return find3(path12.dirname(start), rel2);
        }
      }
    ...
    var json = exports2.json = function() {
      ...
      var file = path12.join.apply(null, args);
      var content;
      try {
...
var require_defaults = __commonJS({
  "libs/core/src/lib/npm-conf/defaults.ts"(exports2) {
    ...
    if (home) {
      ...
      home = import_path15.default.resolve(temp, `npm-${uidOrPid}`);
    }
    var cacheExtra = process.platform === "win32" ? "npm-cache" : ".npm";
    var cacheRoot = process.platform === "win32" && process.env["APPDATA"] || home;
    var cache = import_path15.default.resolve(cacheRoot, cacheExtra);
    var defaults;
    var globalPrefix;
    Object.defineProperty(exports2, "defaults", {
      get() {
        ...
        if (process.env["PREFIX"]) {
          ...
          globalPrefix = import_path15.default.dirname(process.execPath);
        } else {
          globalPrefix = import_path15.default.dirname(import_path15.default.dirname(process.execPath));
          if (process.env["DESTDIR"]) {
            globalPrefix = import_path15.default.join(process.env["DESTDIR"], globalPrefix);
          }
        }
        defaults = {
          access: null,
          ...
          "commit-hooks": true,
          global: false,
          globalconfig: import_path15.default.resolve(globalPrefix, "etc", "npmrc"),
          "global-style": false,
          ...
          "init-module": import_path15.default.resolve(home, ".npm-init.js"),
          "init-author-name": "",
          "init-author-email": "",
          "init-author-url": "",
          "init-version": "1.0.0",
          ...
          userconfig: import_path15.default.resolve(home, ".npmrc"),
...
var require_npm_conf = __commonJS({
  "libs/core/src/lib/npm-conf/index.ts"(exports2, module2) {
    ...
    function npmConf3(opts) {
      ...
      conf.addEnv();
      conf.loadPrefix();
      const projectConf = import_path15.default.resolve(conf["localPrefix"], ".npmrc");
      ...
      if (conf["get"]("prefix")) {
        const etc = import_path15.default.resolve(conf["get"]("prefix"), "etc");
        conf.root.globalconfig = import_path15.default.resolve(etc, "npmrc");
        conf.root.globalignorefile = import_path15.default.resolve(etc, "npmignore");
      }
...
async function tempWrite(fileContent, filePath) {
  ...
  await import_node_fs.default.promises.mkdir(import_path13.default.dirname(tempPath), { recursive: true });
  await write(tempPath, fileContent);
  return tempPath;
}
var import_node_crypto, import_node_fs, import_node_os2, import_path13, tempDir, tempfile, writeStream;
var init_temp_write = __esm({
  "libs/core/src/lib/temp-write.ts"() {
    ...
    tempfile = (filePath) => import_path13.default.join(tempDir, (0, import_node_crypto.randomUUID)(), filePath || "");
    ...
    tempWrite.sync = (fileContent, filePath) => {
      const tempPath = tempfile(filePath);
      import_node_fs.default.mkdirSync(import_path13.default.dirname(tempPath), { recursive: true });
...
var import_fs_extra8, import_run_many, import_run_one, import_p_map3, import_path14, import_perf_hooks, RunCommand;
var init_src3 = __esm({
  "libs/commands/run/src/index.ts"() {
    "use strict";
    init_src2();
    ...
    RunCommand = class extends Command {
      ...
      async runScriptsUsingNx() {
        ...
        if (this.options.profile) {
          ...
          process.env["NX_PROFILE"] = import_path14.default.relative(this.project.rootPath, absolutePath);
        }
      ...
      async prepNxOptions() {
        const nxJsonExists = (0, import_fs_extra8.existsSync)(import_path14.default.join(this.project.rootPath, "nx.json"));
