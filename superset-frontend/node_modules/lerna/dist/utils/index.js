...
var tempfile = (filePath) => import_path11.default.join(tempDir, (0, import_node_crypto.randomUUID)(), filePath || "");
...
async function tempWrite(fileContent, filePath) {
  ...
  await import_node_fs.default.promises.mkdir(import_path11.default.dirname(tempPath), { recursive: true });
  await write(tempPath, fileContent);
  return tempPath;
}
tempWrite.sync = (fileContent, filePath) => {
  const tempPath = tempfile(filePath);
  import_node_fs.default.mkdirSync(import_path11.default.dirname(tempPath), { recursive: true });
