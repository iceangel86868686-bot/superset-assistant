 ...
 */
export class WfsDataParser {
    /**
     * The name of the WfsDataParser.
     */
    static title = 'WFS Data Parser';
     ...
     */
    generateRequestParamString(params) {
     ...
     */
    mapXsdTypeToJsonDataType(qualifiedXsdDataType) {
     ...
     */
    async readData({ url, requestParams, fetchParams = {} }) {
        ...
        try {
            ...
            if (attributes) {
                ...
                attributes.forEach((attr) => {
                    ...
                    if (!properties[name]) {
                        const propertyType = { type: this.mapXsdTypeToJsonDataType(type) };
