import { QueryParamConfigMap, DecodedValueMap, QueryParamConfig, ToBeEncodedValueMap } from 'serialize-query-params';
/**
 ...
 */
export declare type SetQuery<QPCMap extends QueryParamConfigMap> = (changes: Partial<ToBeEncodedValueMap<QPCMap>> | ((latestValues: DecodedValueMap<QPCMap>) => Partial<ToBeEncodedValueMap<QPCMap>>), updateType?: UrlUpdateType) => void;
