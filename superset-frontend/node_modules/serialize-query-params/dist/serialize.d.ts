 ...
 */
export declare function decodeDate(input: EncodedValue): Date | null | undefined;
/**
 ...
 * @return {Date} parsed date
 */
export declare function decodeDateTime(input: EncodedValue): Date | null | undefined;
/**
 ...
 */
export declare function decodeBoolean(input: EncodedValue): boolean | null | undefined;
/**
 ...
 */
export declare function decodeNumber(input: EncodedValue): number | null | undefined;
/**
 ...
 */
export declare function encodeString(str: EncodedValue): string | null | undefined;
/**
 ...
 */
export declare function decodeString(input: EncodedValue): string | null | undefined;
/**
 ...
 */
export declare function decodeEnum<T extends string>(input: EncodedValue, enumValues: T[]): T | null | undefined;
/**
 ...
 */
export declare function decodeArrayEnum<T extends string>(input: EncodedValue, enumValues: T[]): T[] | null | undefined;
/**
 * Decodes an enum value from arrays while safely handling null and undefined values.
 *
 * @template T
 ...
 * @return {T[]} the string value from enumValues
 */
export declare function decodeDelimitedArrayEnum<T extends string>(input: EncodedValue, enumValues: T[], entrySeparator?: string): T[] | null | undefined;
/**
 ...
 */
export declare function decodeJson(input: EncodedValue): any | null | undefined;
/**
 ...
 */
export declare function decodeArray(input: EncodedValue): (string | null)[] | null | undefined;
/**
 ...
 * @return {Array} The javascript representation
 */
export declare function decodeNumericArray(input: EncodedValue): (number | null)[] | null | undefined;
/**
 ...
 * @return {Array} The javascript representation
 */
export declare function decodeDelimitedArray(input: EncodedValue, entrySeparator?: string): (string | null)[] | null | undefined;
/**
 ...
 * @return {Array} The javascript representation
 */
export declare function decodeDelimitedNumericArray(arrayStr: EncodedValue, entrySeparator?: string): (number | null)[] | null | undefined;
/**
 ...
 */
export declare function decodeObject(input: EncodedValue, keyValSeparator?: string, entrySeparator?: string): {
    [key: string]: string;
} | null | undefined;
/**
 ...
 * @return {Object} The javascript object
 */
export declare function decodeNumericObject(input: EncodedValue, keyValSeparator?: string, entrySeparator?: string): {
    [key: string]: number | null | undefined;
} | null | undefined;
