"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[3526],{52208(e,t,i){i.d(t,{A:()=>_});var o=i(15473),s=i(38706),n=i(82849),r=i(59),l=i(63583),a=i(53014),c=i(23479);let u={name:"phongMaterial",dependencies:[l.x],source:a.X,vs:c.X,fs:c.l,defines:{LIGHTING_FRAGMENT:!0},uniformTypes:{ambient:"f32",diffuse:"f32",shininess:"f32",specularColor:"vec3<f32>"},defaultUniforms:{ambient:.35,diffuse:.6,shininess:32,specularColor:[.15,.15,.15]},getUniforms(e){let t={...e};return t.specularColor&&(t.specularColor=t.specularColor.map(e=>e/255)),{...u.defaultUniforms,...t}}};var d=i(34521),f=i(65771),h=i(48186),m=i(25140),p=i(82050);class g extends m.V{constructor(e){const{indices:t,attributes:i}=function(e){let{radius:t,height:i=1,nradial:o=10}=e,{vertices:s}=e;s&&(h.A.assert(s.length>=o),s=s.flatMap(e=>[e[0],e[1]]),(0,p.UD)(s,p.rJ.COUNTER_CLOCKWISE));let n=i>0,r=o+1,l=n?3*r+1:o,a=2*Math.PI/o,c=new Uint16Array(n?3*o*2:0),u=new Float32Array(3*l),d=new Float32Array(3*l),f=0;if(n){for(let e=0;e<r;e++){let n=e*a,r=e%o,l=Math.sin(n),c=Math.cos(n);for(let e=0;e<2;e++)u[f+0]=s?s[2*r]:c*t,u[f+1]=s?s[2*r+1]:l*t,u[f+2]=(.5-e)*i,d[f+0]=s?s[2*r]:c,d[f+1]=s?s[2*r+1]:l,f+=3}u[f+0]=u[f-3],u[f+1]=u[f-2],u[f+2]=u[f-1],f+=3}for(let e=+!n;e<r;e++){let n=Math.floor(e/2)*Math.sign(.5-e%2),r=n*a,l=(n+o)%o,c=Math.sin(r),h=Math.cos(r);u[f+0]=s?s[2*l]:h*t,u[f+1]=s?s[2*l+1]:c*t,u[f+2]=i/2,d[f+2]=1,f+=3}if(n){let e=0;for(let t=0;t<o;t++)c[e++]=2*t+0,c[e++]=2*t+2,c[e++]=2*t+0,c[e++]=2*t+1,c[e++]=2*t+1,c[e++]=2*t+3}return{indices:c,attributes:{POSITION:{size:3,value:u},NORMAL:{size:3,value:d}}}}(e);super({...e,indices:t,attributes:i})}}let v=`\
